...
class CustomCheckBox(UserControl):
    def __init__(self, color, label='', selection_fill='#183588', size=25, stroke_width=2, 
                 animation=None, checked=False, font_size=17, pressed=None, checked_color="#183588"):
        super().__init__()
        ...
        self.CHECKED = checked_color  # Novo parâmetro para definir a cor do ícone quando selecionado
    ...
    def _checked(self):
        self.check_box = Container(
            ...
            bgcolor=self.CHECKED,  # Usando a cor definida no parâmetro
